...
const MockedComponent = ({mockNavigate}) => {
    const onAccountClick = () => {
        mockNavigate(createPathWithDefaults('/account'))
    }
    const onWishlistClick = () => {
        mockNavigate(createPathWithDefaults('/account/wishlist'))
    }
    return (
        <div>
...
test('route to account page when an authenticated users click on account icon', async () => {
    ...
    renderWithProviders(<MockedComponent mockNavigate={mockNavigate} />)
    ...
    await waitFor(() => {
        expect(mockNavigate).toHaveBeenCalledWith(createPathWithDefaults('/account'))
    })
...
test('route to wishlist page when an authenticated users click on wishlist icon', async () => {
    ...
    await waitFor(() => {
        expect(mockNavigate).toHaveBeenCalledWith(createPathWithDefaults('/account/wishlist'))
    })
})
